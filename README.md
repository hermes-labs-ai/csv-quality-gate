# csv-quality-gate is a data quality gate for CSV pipelines

csv-quality-gate is a data quality gate that runs CSV preflight validation and batch quality checks, failing fast before a pipeline ingests broken, incomplete, duplicated, or junk input.
